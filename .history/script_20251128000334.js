class VocabularyApp {
    ...
    renderQuestion() {
        console.log('Rendering question:', this.currentQuizIndex); // Debug log
        ...
        // Update progress - FIXED: Show current progress correctly
        ...
        if (isCorrect) {
            ...
            allOptions.forEach(opt => {
                if (opt !== btnElement && !opt.classList.contains('correct')) {
                    ...
                    const correctAnswer = this.quizQuestions[this.currentQuizIndex];
                    let correctText = '';
                    
                    if (this.quizMode === 'chinese-meaning') {
                        correctText = formatAllMeanings(correctAnswer);
                    } else if (this.quizMode === 'meaning-chinese' || this.quizMode === 'pinyin-chinese') {
                        correctText = correctAnswer.chinese;
                    } else if (this.quizMode === 'chinese-pinyin') {
                        correctText = correctAnswer.pinyin;
                    }
