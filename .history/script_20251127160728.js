    ...
    `);
        ...
        case 'english-front':
            frontContent.innerHTML = `
                <div class="english-meaning">${currentWord.english}</div>
                ${currentWord.pos ? `<div class="pos">(${currentWord.pos})</div>` : ''}
            `;
            backContent.innerHTML = `
        ...
        case 'vietnamese-front':
            frontContent.innerHTML = `
                <div class="vietnamese-meaning">${currentWord.vietnamese}</div>
                ${currentWord.pos ? `<div class="pos">(${currentWord.pos})</div>` : ''}
            `;
            backContent.innerHTML = `
                <div class="chinese-character">${currentWord.chinese}</div>
        ...
        case 'pinyin-front':
            frontContent.innerHTML = `<div class="pinyin-large">${currentWord.pinyin}</div>`;
            backContent.innerHTML = `
                <div class="chinese-character">${currentWord.chinese}</div>
                <div class="meaning">${currentWord.english}</div>
                <div class="meaning">${currentWord.vietnamese}</div>
...
showQuizResults() {
    ...
    // No need to rebind events if using event delegation
}
