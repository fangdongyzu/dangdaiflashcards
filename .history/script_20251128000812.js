class VocabularyApp {
  ...
  startQuiz() {
    ...
    renderQuestion() {
        console.log('Rendering question:', this.currentQuizIndex + 1, 'of', this.quizQuestions.length);
    ...
    handleAnswer(isCorrect, btnElement) {
        console.log('Answer handled, correct:', isCorrect);
        ...
        if (isCorrect) {
            ...
            const questionData = this.quizQuestions[this.currentQuizIndex];
            allOptions.forEach(opt => {
                if (opt !== btnElement && !opt.classList.contains('correct')) {
        ...
        console.log('Next question button should now be visible');
    ...
    nextQuestion() {
        ...
        console.log('Current index:', this.currentQuizIndex, 'Total questions:', this.quizQuestions.length);
        
        this.currentQuizIndex++;
        console.log('Moving to index:', this.currentQuizIndex);
    ...
    showQuizResults() {
        ...
        console.log('Quiz completed. Score:', this.quizScore, '/', this.quizQuestions.length);
    }
   ...
   nextQuestion() {
        console.log('Next question called, current index:', this.currentQuizIndex); // Debug log
        ...
        this.currentQuizIndex++;
        console.log('Moving to index:', this.currentQuizIndex); // Debug log
   ...
   showQuizResults() {
        console.log('Showing quiz results'); // Debug log
