class VocabularyApp {
    ...
    constructor() {
        ...
        // Language settings
        // CHANGED: Initialize as empty array so nothing is selected by default
    ...
    setupLanguageSelection() {
        ...
        languageCheckboxes.forEach(checkbox => {
            // CHANGED: Force uncheck visually on load
        ...
        // Ensure internal state matches the unchecked UI
        this.updateSelectedLanguages();
    }
