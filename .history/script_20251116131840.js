class VocabularyApp {
   ...
   displayFlashcard() {
    ...
    // FIX: Use event delegation on the quiz container
    quizContainer.addEventListener('click', (e) => {
        if (e.target.id === 'restart-quiz-btn') {
            console.log('Restart quiz clicked'); // Debug log
            this.startSelectedQuiz();
        } else if (e.target.id === 'new-quiz-btn') {
            console.log('New quiz clicked'); // Debug log
