class VocabularyApp {
   ...
   showQuizResults() {
    ...
    // FIXED: Hide the next question button permanently after quiz completion
    const nextBtn = document.getElementById('next-question-btn');
    nextBtn.classList.add('hidden');
    nextBtn.style.display = 'none'; // Ensure it's completely hidden
    ...
    // Remove the text change since we're hiding the button permanently
    // nextBtn.textContent = 'Retry Quiz'; // Remove this line
}
