class VocabularyApp {
    ...
    bindEvents() {
        ...
        // Quiz type selection
        this.safeAddEventListener('quiz-type-select', 'change', (e) => {
        ...
        this.safeAddEventListener('start-quiz-btn', 'click', () => this.startQuiz());
    ...
    displayQuizQuestion() {
        const quizContent = this.getElement('quiz-content');
        if (!quizContent) {
    ...
    showQuizResults() {
        ...
        this.safeAddEventListener('restart-quiz-btn', 'click', () => this.startQuiz());
    ...
    displayQuizInstructions() {
        ...
        this.safeAddEventListener('start-quiz-from-tab', 'click', () => {
            this.startQuiz();
        });
    }
