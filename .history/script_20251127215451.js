class VocabularyApp {
    ...
    parseCSV(text) {
        ...
        const keyMap = {
            ...
            '泰譯': 'burmese',    // Column labeled "Thai" actually has Burmese
            '緬譯': 'japanese',   // Column labeled "Burmese" actually has Japanese
            '日譯': 'korean',     // Column labeled "Japanese" actually has Korean
            '韓譯': 'english'     // Assuming the last one is English (or empty)
        };
