class VocabularyApp {
    ...
    bindEvents() {
        ...
        document.getElementById('lesson-select').addEventListener('change', (e) => {
            ...
            // Reset flashcard index when lesson changes
            this.currentFlashcardIndex = 0;
            // Update flashcard display if we're in flashcards tab
        ...
        document.getElementById('mode-select').addEventListener('change', (e) => {
            ...
            // Update current flashcard if we're in flashcards tab
            if (document.getElementById('flashcards-content').classList.contains('active')) {
                this.displayFlashcard();
            }
        });
    ...
    displayFlashcard() {
        ...
        // If no vocabulary for current lesson, show empty state
        if (filteredVocab.length === 0) {
        ...
        // Always start with card unflipped
    ...
    switchTab(tabName) {
        ...
        // When switching to flashcards tab, display current flashcard
    ...
    practiceDifficultWords() {
        ...
        this.currentFlashcardIndex = 0; // Start from first word
        this.displayFlashcard();
        this.switchTab('flashcards');
