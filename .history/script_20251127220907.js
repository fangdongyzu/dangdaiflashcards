flash card is like this

VN:

ผู้หญิงเวียดนาม (phu ying wiat nam)TH:

ဗီယက်နမ်အမျိုးသမီး (viet nam a myo tha mee)MM:

ベトナム出身の女性 (Betonamu shusshin no josei)JP:

베트남 여자 (beteunam yeoja)KR:
...
'英譯': 'english', // Column labeled "English" actually has Vietnamese

'越譯': 'vietnamese', // Column labeled "Vietnamese" actually has Thai

'泰譯': 'thai', // Column labeled "Thai" actually has Burmese

'緬譯': 'burmese', // Column labeled "Burmese" actually has Japanese

'日譯': 'japanese', // Column labeled "Japanese" actually has Korean

'韓譯': 'korean' // Assuming the last one is English (or empty)
