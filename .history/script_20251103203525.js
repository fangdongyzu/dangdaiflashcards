class VocabularyApp {
    ...
    startQuiz() {
        ...
        if (this.quizQuestions.length === 0) {
            this.showMessage('Not enough vocabulary to generate quiz questions. Need at least 2 words.', 'warning');
            return;
        }
    ...
    generateQuizQuestions(vocabulary) {
        ...
        console.log('Generating quiz questions from vocabulary:', vocabulary);
    ...
    displayQuizQuestion() {
        ...
        if (this.quizQuestions.length === 0) {
            ...
            document.getElementById('try-again-quiz').addEventListener('click', () => {
                this.startQuiz();
            });
            return;
        }
    ...
    displayQuizInstructions() {
        ...
        quizContent.innerHTML = `
            <div class="text-center">
                ...
                <p>Test your knowledge with multiple-choice questions about pinyin and meanings.</p>
